...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { date: @table.date, image: @table.image, image_name: @table.image_name, price: @table.price, star: @table.star, title: @table.title, url: @table.url }
    end
  ...
  test "should update table" do
    patch :update, id: @table, table: { date: @table.date, image: @table.image, image_name: @table.image_name, price: @table.price, star: @table.star, title: @table.title, url: @table.url }
    assert_redirected_to table_path(assigns(:table))
  end
